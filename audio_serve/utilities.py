...
ENGLISH_WORDS_MAPPING = [
    ...
    {"P2 Lite": ["pictrue light", "p too light", "p two light", "p to light", "p 2 lite", "p 2 light"]},
    {"T2 Mini": ["T two mini", "to me ni", "meaning,mini", "t 2 mini"]},
    {"T2 Lite": ["t too light", "t to light", "too light", "to light", "t 2 lite", "t 2 light"]},
    {"P2 Pro": ["p two pro", "p too pro", "peter pro", "p to pro", "p 2 pro"]},
    {"V2 Pro": ["v true pro", "v too pro", "v two pro", "v to pro", " v 2 pro"]},
    {"Blink": ["blank,link"]},
    {"L2K": ["l two k", "l too k", "l to k", "l 2 k"]},
    {"V1S": ["v one s", "v 1 s", " v1 s", "v 1s"]},
    {"ESL": ["e s l", "e xl"]},
    {"M2": ["am too", "am two", "am to", "m too", "m two", "m to", "m 2"]},
    {"P1": ["p one", "p 1"]},
    {"D2": ["the too", "the two", "d 2"]},
    {"L2": ["air too", "air two", "el too", "el two", "air to", "el to", "l too", "l two", "l to", "l 2"]},
    {"S2": ["ass too", "as too", "ask to", "ass to", "us to", "s two", "as to", "s too", "s to", "s 2"]},
    {"T2": ["t too", "t to", "t 2"]},
    {"K1": ["ok one", "K one", "k 1"]},
    {"H1": ["H one"]},
    {"V2": ["v too", "v two", "vito", "v tu", "v to", "v 2"]},
    {"W1": ["w one", "w 1"]},
